TRAIN_IMG_SRC_FOLDER = "/home/guilherme/Documents/noa/cidia19/data/spgc/views66_320"
VALIDATION_IMG_SRC_FOLDER = "/home/guilherme/Documents/noa/cidia19/data/spgc/views66_320"
...
EPOCHS = 20
IMG_HEIGHT = 320 #384 #320 #224
IMG_WIDTH = 320 #384 #320 #224
IMG_CHANNELS = 3
SELECTED_MODEL = ''
NUM_CLASSES = 3
ACCURACY = 'accuracy'
# ACCURACY = 'binary_accuracy'
DATA_FOLDER = 'spgc-ternario-tf66-320x320-oversampling/'
...
#     print(dfs)
    ...
    if OVERSAMPLING:
        ...
        labels_count = df_labels.groupby('label')['label'].count()
        n_max = labels_count[labels[0]]
        
        for l in labels:
            n_max = max(n_max, labels_count[l])

        for l in labels:
            df_temp = train_df[train_df['label'] == l]
            if len(df_temp) < n_max:
                rows = n_max - len(df_temp)
                df_temp = df_temp.sample(n=rows,replace=True)
