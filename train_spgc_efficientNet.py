...
DATA_FOLDER = 'spgc-ternario-tf66-effnB6-4/'
...
def get_base_model():
    base_model = tf.keras.applications.EfficientNetB6(weights='imagenet', include_top=False, input_shape=(IMG_HEIGHT, IMG_WIDTH, 3))
    return base_model
